...
plot(GRF);
hold on
plot(GE(:,1),ones(nstrides,1)*threshold, 'rx','LineWidth',2);
plot(GE(:,2),ones(nstrides,1)*threshold, 'bo','LineWidth',2);
plot(GE(:,3),ones(nstrides,1)*threshold, 'bx','LineWidth',2);
plot(GE(:,4),ones(nstrides,1)*threshold, 'ro','LineWidth',2);
